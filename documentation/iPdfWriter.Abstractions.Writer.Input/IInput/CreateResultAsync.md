...
Returns a new reference [`OutputResult`](../../iPdfWriter.Abstractions.Writer.Operations.Results/OutputResult.md) that complies with what is indicated in its configuration object. By default, this input will not be zipped.
...
The type of the return Result is [`IOutputResultConfig`](../../iPdfWriter.Abstractions.Writer.Config/IOutputResultConfig.md), which contains the operation result
